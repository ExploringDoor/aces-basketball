...
import { FadeIn, Spade, centralLeagueTeams, centralLeagueChampions, teamLogos } from "../shared";
...
const TeamBadge = ({ team, size = 44 }) => {
  const logo = team.logo || teamLogos[team.name];
  return logo
    ? <div style={{ width: size, height: size, borderRadius: "50%", background: "#fff", border: `2px solid ${team.color}`, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}><img src={logo} alt={team.name} style={{ width: "88%", height: "88%", objectFit: "contain" }} /></div>
